# Modulmanifest für das Modul "OSDProgress"
###################################################
@{
    ...
    ModuleVersion     = '21.7.2.2'

    # Unterstützte PSEditions
    # CompatiblePSEditions = @()

    # ID zur eindeutigen Kennzeichnung dieses Moduls
    GUID              = '62f26063-4d41-412c-9980-c12b04bde9c2'

    # Autor dieses Moduls
    Author            = 'Christopher Strobel @abaChrisStr'
    ...
    Description       = 'Lightweight Progress screen for Powershell driven OSD'
    ...
    'Import-OSDProgress',
    'Read-OSDLog',
    'Save-OSDProgressFile',
    'Save-WebFileOverride',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/ChrisStro/OSDProgress'
